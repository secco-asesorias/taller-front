...
const ACCIONES = [
  ...
  { label: 'Actas', ruta: 'actas', icon: '📂', desc: 'Historial de recepciones' },
  { label: 'Diagnósticos', ruta: 'diagnosticos', icon: '🔧', desc: 'Informes técnicos' },
  { label: 'Cotizaciones', ruta: 'cotizaciones', icon: '💰', desc: 'Presupuestos y propuestas' },
  { label: 'Órdenes de Trabajo', ruta: 'ordenes-trabajo', icon: '⚙️', desc: 'Gestión de trabajos' },
